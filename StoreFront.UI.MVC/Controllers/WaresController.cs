...
namespace StoreFront.UI.MVC.Controllers
{
    public class WaresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Wares,WaresId,Description,TypeId,Price,ManufacturerId,StockStatusId,Quantity")] Ware ware)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Wares,WaresId,Description,TypeId,Price,ManufacturerId,StockStatusId,Quantity")] Ware ware)
        {
            if (id != ware.WaresId)
            {
                return NotFound();
