...
namespace StoreFront.UI.MVC.Controllers
{
    public class TypesController : Controller
    {
        ...
        public TypesController(UndeadBurgGeneralContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Types != null ? 
                          ...
                          Problem("Entity set 'UndeadBurgGeneralContext.Types'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UndeadBurgGeneralContext.Types'  is null.");
            }
            var @type = await _context.Types.FindAsync(id);
            if (@type != null)
            {
